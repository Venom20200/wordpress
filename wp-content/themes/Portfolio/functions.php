<?php
/*Ce fichier fait partie dePortfolio, neve child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function Portfolio_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'Portfolio_enqueue_child_styles' );
