<?php
/*Ce fichier fait partie deChildgenerator, twentytwentyone child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function Childgenerator_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'Childgenerator_enqueue_child_styles' );
